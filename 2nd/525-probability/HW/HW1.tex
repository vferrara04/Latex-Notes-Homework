...
\subsection*{2.}
Collaborators: Keertan\\
Let $S=\{1,\dots,100\}$ and $\P(D)=|D|/100$ for $D \subset S$\\
$A=\{1,2,3,\dots,70\}$\\
$B=\{1,2,3,\dots,45,71,72,\dots,100\}$\\
$C=\{1,2,3,\dots,25,46,47,\dots,100\}$\\
$|A|=70,\; |B|=75,\; |C|=80$\\
$A\cap B \cap C = \{1,2,\dots,25\}$\\
Thus $\P(A \cap B \cap C)=.25$\\
Thus the minimal value of $\P(A \cap B \cap C)=.25$
\newpage
...
\\
\P(\text{Same from two diff} \mid B_1,B_2)&=\dfrac{\text{number of good outcomes}}{\text{all outcomes}}=\frac{3}{18}=\frac{1}{6}\\
\P(\text{Same from two diff} \mid B_1,B_3)&=\frac{2}{12}=\frac{1}{6}\\
