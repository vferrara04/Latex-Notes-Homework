...
Another Separate proof:
    ...
    \begin{proof}
        ...
        Since $G=g_1H\cup g_2H\cup \ldots\cup g_mH$ and these are all disjoint by Lagrange's Theorem
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        By proof above $[G:H]=\frac{|G|}{|H|}=\frac{2p}{p}=2$. Take $g\notin H \implies G=H\sqcup gH$
